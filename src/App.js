  ...
  state = {
    books: [
      ...
      },
      {
        ...
        title: "The Advetures of Tom Sawyer",
        authors: ["Mark Twain"],
        status: BookStatus.READ,
      },
    ],
  };
  changeBookStatus = (newStatus, argBook) => {
    ...
    return (
      <div className="app">
        <Route
          ...
          path="/"
          render={() => (
            <BookList books={books} bookSelected={this.changeBookStatus} />
          )}
        />
        <Route
          path="/search"
          render={() => (
            <SearchPage bookSelected={this.changeBookStatus} books={books} />
          )}
        />
      </div>
    );
